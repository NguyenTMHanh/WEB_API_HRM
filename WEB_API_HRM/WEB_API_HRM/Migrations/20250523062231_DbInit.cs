    ...
    public partial class DbInit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleModuleActions", x => new { x.RoleId, x.ModuleId, x.ActionId });
                    table.ForeignKey(
                        name: "FK_RoleModuleActions_Actions_ActionId",
                        column: x => x.ActionId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleModuleActions_Modules_ModuleId",
                        column: x => x.ModuleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleModuleActions_ActionId",
                table: "RoleModuleActions",
                column: "ActionId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleModuleActions_ModuleId",
                table: "RoleModuleActions",
                column: "ModuleId");
        }
